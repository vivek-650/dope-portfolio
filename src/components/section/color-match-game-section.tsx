...
export default function ColorMatchGameSection() {
  return (
    <div className="rounded-xl border border-white/10 bg-card/30 backdrop-blur-xl p-4 sm:p-6 shadow-[0_12px_34px_-24px_rgba(0,0,0,0.45)] relative overflow-hidden">
      ...
      >
        <Link href="/color-match" aria-label="Open Color Match game">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3 pr-14">
          <p className="text-base text-muted-foreground font-medium">
            Color Match. Dial in Hue, Saturation, and Brightness to match Pikachu&apos;s true fur color.
          </p>
        </div>

        <ColorMatchGame variant="mini" />
      </div>
    </div>
  );
}
