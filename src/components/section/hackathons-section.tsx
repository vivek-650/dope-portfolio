        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          <div className="flex items-center w-full">
            ...
            <div className="border bg-primary z-10 rounded-xl px-4 py-1">
              <span className="text-background text-xs font-medium uppercase tracking-wide">Hackathons</span>
            </div>
            <div className="flex-1 h-px bg-linear-to-l from-transparent from-5% via-border via-95% to-transparent" />
          </div>
          <div className="flex flex-col gap-y-3 items-center justify-center">
            <h2 className="text-2xl sm:text-3xl tracking-tight">I like building things</h2>
          ...
          {hackathons.map((hackathon) => (
            <TimelineItem key={hackathon.title + hackathon.dates} className="w-full flex items-start justify-between gap-10">
              ...
              <div className="flex flex-1 flex-col justify-start gap-2 min-w-0">
                ...
                {hackathon.title && (
                  <h3 className="text-base sm:text-lg tracking-tight leading-none">{hackathon.title}</h3>
                )}
                {hackathon.location && (
